...
module "oke" {
  ...
  mlflow_node_pool_name                                                     = var.mlflow_node_pool_name
  mlflow_node_pool_shape                                                    = var.mlflow_node_pool_shape
  mlflow_node_pool_size                                                     = var.mlflow_node_pool_size
  ...
  is_flex_node_shape                                                          = contains(local.compute_flexible_shapes, var.mlflow_node_pool_shape)
}
...
module "object_storage" {
 ...
 compartment_ocid = var.compartment_ocid
 useExistingBucket = var.useExistingBucket
}

module "bastion" {
  depends_on                         = [module.oke, module.network,module.object_storage]
  ...
  obj_storage_namespace              = module.object_storage.obj_storage_namespace
  bucket_name                        = var.useExistingBucket ? var.bucket_name : module.object_storage.bucket_name
